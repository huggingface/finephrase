...
parser.add_argument("--qos", type=str, default="high", help="qos to use")
parser.add_argument("--time", type=str, default="1:00:00", help="slurm time limit. 1:00:00 by default")
parser.add_argument("--parallel", type=int, default=5, help="How many eval tasks to run simultaneously")
parser.add_argument("--batch-size", type=int, default=None, help="Batch size")
parser.add_argument("--gpus", type=int, default=8, help="How many gpus to use")
